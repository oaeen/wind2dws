...
class Wendy_Full(nn.Module):
    def __init__(self, freq_num=36, large_days=10, local_days=3, unet3d_out=16):
        super(Wendy_Full, self).__init__()
        ...
        self.out = nn.Conv2d(45, 1, kernel_size=1)
